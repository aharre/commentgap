...
dates_raw <- seq(as.Date("2022/10/1"), as.Date("2022/10/31"), by="days")
...
for(i in article_links_clean[1909:length(article_links_clean)]){
  Sys.sleep(1)
...
# safety copy 
write.csv(article_info, "article_info_1022.csv")
